...
<body>
    ...
    @auth
        ...
        <div class="container" style="margin-top: 70px; justify-content: center; align-items: center;">
            <p style="font-size: 22px;">Choose your<br><span
                    style="font-size: 35px; font-weight: 600; color: #34364A;">Learning Materials</span></p>

            <!-- CARD 1 -->
            <!-- <div class="row" style="margin-top: 45px; display: flex; justify-content: center; align-items: center;"> -->
            <div class="row" style="margin-top: 45px;">
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src={{ asset('./images/cards/Android.png') }} class="card-img-top"
                ...
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src={{ asset('./images/cards/Flutter.png') }} class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div style="margin-top: auto;">
                            <a href="{{ route('flutterHome') }}" class="btn btn-primary">Start Learning</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card p-0"
                    style="width: 305px; height:375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src={{ asset('./images/cards/Node.js.png') }} class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="row" style="margin-top: 45px;">
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/Python.png') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
                ...
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/MySQL.png') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
                ...
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/PostgreSQL.png') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="row" style="margin-top: 45px;">
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/Network.png ') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
                ...
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/Unity.png') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
                ...
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/Data analytic.png ') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="row" style="margin-top: 45px;">
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/PHP.png ') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
                ...
                <div class="card p-0"
                    style="width: 305px; height: 375px; margin-left: 25px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <img src="{{ asset('./images/cards/DB.png ') }}" class="card-img-top"
                        style="width: auto; height: 200px;">
                    <div class="card-body d-flex flex-column">
            ...
            <div class="row">
                <div class="col">
                    <div class="container" style="margin-top: 40px;">
                        ...
                        <p style="font-size: 16px;  color: #636363;">Intelligent Computer Assisted<br>Programming Learning
                            Platform.</p>
                    </div>
                    <div class="container">
                ...
                <div class="col">
                    <div class="container">
                        <p style="font-size: 22px; font-weight: 600; color: #34364A; margin-top: 40px; margin-left: 55px;">
                            Company</p>
                ...
                <div class="col">
                    <div class="container">
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col">
                                <p style="font-size: 16px;  color: #636363;">Jl. Candi Mendut, RT.02/RW.08, Mojolangu, Kec.
                ...
                <p style="font-size: 16px; color: #636363; text-align: center; margin-top: 16px; margin-bottom: 16px;">©
                    2023 iCLOP. All rights reserved</p>
            </div>
        </div>
        </div>
    @endauth
